...
//rout handlers, grouped by resource
...
//core middlware: allow cross-origin requests ( frontend runs on a different port1)
// and parse incoming JSON bodies
app.use(cors());
app.use(express.json());
app.use(express.urlencoded({ extended: true }));

// Mount each resources's routes under its own /api/* base path
...
// Simple uptime/health check, useful for deployment platforms
